...
function Register({ navigation }) {
  ...
  function handleEmptyFields() {
    if (name === "") {
      ...
      Alert.alert(
        "Atenção",
        "Necessário preencher o campo de confimação de senha."
      );
        ...
        <View style={styles.bottom}>
          ...
          <View style={{ flexDirection: "row", borderColor: borderGender }}>
            <CheckBox
              ...
              checked={fChecked}
              onPress={() => {
                setFChecked(true), setMChecked(false), setGender("Female");
              }}
            />
            <CheckBox
              containerStyle={{
              ...
              checked={mChecked}
              onPress={() => {
                setMChecked(true), setFChecked(false), setGender("Male");
              }}
            />
          </View>
          ...
          <View style={{ flexDirection: "row", borderColor: borderInter }}>
            <CheckBox
              ...
              onPress={() => {
                maleInterest ? setMaleInterest(false) : setMaleInterest(true);
              }}
            />
            <CheckBox
              containerStyle={{
              ...
              onPress={() => {
                femaleInterest
                  ? setFemaleInterest(false)
                  : setFemaleInterest(true);
              }}
            />
          </View>
          <TouchableOpacity style={styles.submmit} onPress={handleSubmit}>
